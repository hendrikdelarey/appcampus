...
{
    public class MacAddress : IValueObject<MacAddress>
    {
        ...
        {
            return Regex.IsMatch(macAddress, "^[0-9A-F]{2}-[0-9A-F]{2}-[0-9A-F]{2}-[0-9A-F]{2}-[0-9A-F]{2}-[0-9A-F]{2}$", RegexOptions.IgnoreCase);
        }
